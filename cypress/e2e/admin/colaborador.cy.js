...
/**
 * Testes E2E - Página de Colaboradores
 * 
 * Cobertura:
 * - Renderização da página
 * - Tabela de colaboradores com colunas (Nome, Email, CPF, Telefone, Portaria, Cargo, Status)
 * - Campo de busca (por nome, CPF ou portaria)
 * - Filtros por nível de acesso (Operador, Secretário, Administrador)
...
describe('Dashboard Admin - Página de Colaborador', () => {
  ...
  describe('Criação de colaborador', () => {
  ...
  describe('Edição de colaborador', () => {
