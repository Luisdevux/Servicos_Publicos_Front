...
function SidebarGroupLabel({
  ...
  return (
    <Comp
      ...
      className={cn(
        "ring-sidebar-ring flex h-8 shrink-0 items-center rounded-md px-2 text-xs font-medium outline-hidden transition-[margin,opacity] duration-200 ease-linear text-global-text-primary [&>svg]:size-4 [&>svg]:shrink-0",
